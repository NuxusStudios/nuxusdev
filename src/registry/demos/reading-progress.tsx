...
export default function DemoScrollProgress() {
  ...
  return (
    <div ref={ref} className="relative h-[420px] overflow-y-auto bg-background">
      ...
      <div className="mx-auto max-w-lg px-6 pb-16">
        <h2 className="text-2xl font-semibold tracking-tight text-foreground">Scroll to fill</h2>
        <div className="mt-6 space-y-4">
          {Array.from({ length: 12 }).map((_, i) => (
            <p key={i} className="text-sm leading-relaxed text-foreground/45">
