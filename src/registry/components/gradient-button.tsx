...
export function GradientButton({
  ...
  return (
    <button
      className={cn(
        "relative inline-flex h-11 items-center justify-center rounded-[11px] px-8 text-sm font-medium text-foreground",
        ...
        variant === "default"
          ? "bg-card before:bg-[conic-gradient(from_var(--angle),#8b5cf6,#22d3ee,#f472b6,#8b5cf6)]"
          : "bg-card before:bg-[conic-gradient(from_var(--angle),#f59e0b,#ef4444,#f59e0b)]",
